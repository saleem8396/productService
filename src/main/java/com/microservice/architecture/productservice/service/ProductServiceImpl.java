...
import com.microservice.architecture.productservice.exception.ProductNotFoundException;
...
public class ProductServiceImpl implements ProductService {
    ...
    public ProductModel getProductById(Long id) {
        ...
        Product product = productRepository.findById(id)
                .orElseThrow(() -> new ProductNotFoundException("no product found","PRODUCT_NOT_FOUND"));
